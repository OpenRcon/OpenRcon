...
private:
    ...
    void addBanListItem(const BanIdTypeEnum &idType, const QString &banId, const BanTypeEnum &type, int seconds, int rounds, const QString &reason);
    void setBanlist(const QList<BanListEntry> &banList);
    void setTemporaryBanEnabled(bool enabled);
