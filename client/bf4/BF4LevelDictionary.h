...
typedef LevelDictionary<3, TeamEntry, LevelEntry, BF4GameModeEntry, GameModeLevelEntry> BF4LevelDictionary;
...
template<> QList<GameModeLevelEntry> BF4LevelDictionary::levelMap;
