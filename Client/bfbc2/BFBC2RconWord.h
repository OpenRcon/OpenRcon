...
#ifndef BFBC2RCONWORD_H
#define BFBC2RCONWORD_H
...
inline QDataStream &operator >> (QDataStream &in, BFBC2RconWord &word)
{
...
inline QDataStream &operator << (QDataStream &out, const BFBC2RconWord &word)
{
    QDataStream::ByteOrder oldbo;
    oldbo = out.byteOrder();
